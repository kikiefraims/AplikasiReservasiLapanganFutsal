    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent inte = new Intent(MainActivity.this, TambahTransaksi.class);
                startActivity(inte);
            }
        });
    ...
    public void RefreshList(){
        ...
        ListView01.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView arg0, View arg1, int arg2, long arg3) {
                ...
                final CharSequence[] dialogitem = {"Detail transaksi", "Edit transaksi", "Hapus transaksi"};
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        switch(item){
                            case 0 :
                                ...
                                i.putExtra("no_pemesanan", selection);
                                startActivity(i);
                                break;
                            case 1 :
                                Intent in = new Intent(getApplicationContext(), EditTransaksi.class);
                                in.putExtra("no_pemesanan", selection);
                                startActivity(in);
                                break;
                            case 2 :
                                SQLiteDatabase db = dbcenter.getWritableDatabase();
                                db.execSQL("delete from transaksi where no_pemesanan = '"+selection+"'");
                                RefreshList();
                                break;
                        }
                    }
